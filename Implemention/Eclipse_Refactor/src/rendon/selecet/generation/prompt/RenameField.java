...
public class RenameField {
	...
	public static void main(String[] args) {
		String prompt = "Please generate five different rename field refactoring test case that meets the following:";
		// 0: keywords; 1：方法调用； 2， 字段调用； 3: name conflict; 4：

		Random random = new Random();// select
		int n1 = random.nextInt(18);

		String renamedMethod = "1. renaming field is " + modifier[n1] + " ;";
...
//		System.out.println("n2:" + n2);
		...
		String condition = "3.  new name of the renaming field is the name(local variable or parameter or field)  that has appeared in the context;";
		prompt = prompt + condition;
		System.out.println(prompt);
	}

	// modifier
	static String[] modifier = { "public", "private", "protected", "default", "static", "abstract", "final",
			"synchronized", " native", "strictfp", "public static", " private static", "protected static",
			"public abstract", "protected abstract", "public final", "private final", "synchronized native",
			"static final" };
