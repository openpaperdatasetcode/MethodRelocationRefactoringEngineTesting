...
class SnippetFinder extends GenericVisitor {
	...
	public static class Match {
		...
		public boolean isInvalidNode() {
			...
			if (candidate == null)
				return false;
			// return invalid if the opening and closing parenthesis of the method signature
			// is part of the node to be replaced
